...
- **allow-domains.dat** (содержит категории `anime`, `block`, `geoblock`, `hodca`, `news`, `porn`, `russia-inside`, `russia-outside`, `ukraine-inside`, `cloudflare`, `cloudfront`, `digitalocean`, `discord`, `google_ai`, `google_play`, `hdrezka`, `hetzner`, `meta`, `ovh`, `roblox`, `telegram`, `tiktok`, `twitter`, `youtube`): 
...
- **allow-services** (содержит категории доменов `cloudflare`, `cloudfront`, `digitalocean`, `discord`, `google_ai`, `google_play`, `hdrezka`, `hetzner`, `meta`, `ovh`, `roblox`, `telegram`, `tiktok`, `twitter`, `youtube`)
...
- **roblox-domains.dat** (содержит категорию `list`): 
  ...
  - [https://github.com/KazZzeL/allow-domains-dat/releases/latest/download/roblox-domains.dat.sha256sum](https://github.com/KazZzeL/allow-domains-dat/releases/latest/download/roblox-domains.dat.sha256sum)
...
- **roblox-subnets.dat** (содержит `IPv4` подсети для `roblox`): 
  ...
  - [https://github.com/KazZzeL/allow-domains-dat/releases/latest/download/roblox-subnets.dat.sha256sum](https://github.com/KazZzeL/allow-domains-dat/releases/latest/download/roblox-subnets.dat.sha256sum)
